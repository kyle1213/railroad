...
for i in range(10002 - sequence_length):
    x_data.append(np.concatenate((np.concatenate((x_data_s_30[i:i + sequence_length-1], y_data_s_30[i:i + sequence_length-1]), axis=1), np.concatenate((x_data_s_30[i + sequence_length-1], [0, 0, 0, 0])).reshape((1,-1))), axis=0))
    y_data.append(y_data_s_30[i+sequence_length-1])
...
for i in range(10002 - sequence_length):
    x_data.append(np.concatenate((np.concatenate((x_data_s_40[i:i + sequence_length-1], y_data_s_40[i:i + sequence_length-1]), axis=1), np.concatenate((x_data_s_40[i + sequence_length-1], [0, 0, 0, 0])).reshape((1,-1))), axis=0))
    y_data.append(y_data_s_40[i+sequence_length-1])

data_s_50 = pd.read_csv('./data/data_c50.csv')
...
for i in range(10002 - sequence_length):
    x_data.append(np.concatenate((np.concatenate((x_data_s_50[i:i + sequence_length-1], y_data_s_50[i:i + sequence_length-1]), axis=1), np.concatenate((x_data_s_50[i + sequence_length-1], [0, 0, 0, 0])).reshape((1,-1))), axis=0))
    y_data.append(y_data_s_50[i+sequence_length-1])
...
for i in range(10002 - sequence_length):
    x_data.append(np.concatenate((np.concatenate((x_data_s_70[i:i + sequence_length-1], y_data_s_70[i:i + sequence_length-1]), axis=1), np.concatenate((x_data_s_70[i + sequence_length-1], [0, 0, 0, 0])).reshape((1,-1))), axis=0))
    y_data.append(y_data_s_70[i+sequence_length-1])
...
for i in range(10002 - sequence_length):
    x_data.append(np.concatenate((np.concatenate((x_data_s_100[i:i + sequence_length-1], y_data_s_100[i:i + sequence_length-1]), axis=1), np.concatenate((x_data_s_100[i + sequence_length-1], [0, 0, 0, 0])).reshape((1,-1))), axis=0))
    y_data.append(y_data_s_100[i+sequence_length-1])
...
torch.save(model.state_dict(), "D:/User_Data/Desktop/github/railroad/model/" + 'straight' + ".pth")
